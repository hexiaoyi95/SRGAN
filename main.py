...
def train():
    ...
    tl.vis.save_images(sample_sub_hr_imgs, [ni, ni], save_dir_gan+'/_train_sample_label.png')
    tl.vis.save_images(sample_sub_lr_imgs, [ni, ni], save_dir_gan+'/_train_sample_input.png')
